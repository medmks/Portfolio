...
const About = () => {
  ...
  Adaptable, highly motivated and ambitious developer with a strong skillset 
  to diligently execute assignments related to web application development, 
  in addition to 6 months of experience working with other interns to develop 
  online stores and websites for businesses.
   Aiming to find an internship where I can develop my skills and knowledge 
  in the field of web development and make a meaningful contribution to the company.
  </motion.p>
